...
Every future candidate starts from V291 or reproduces V291 exactly before adding an experiment.
...
V292A remains test-only until explicit in-game validation.
